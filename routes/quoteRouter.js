...
const { createQuote, getAllQuotes, getQuote, deleteQuote, updateQuote, getQuoteSerialNumber, getQuotesByMonth } = require('../controllers/quoteController')
...
quoteRouter.get('/quotes/getquotesbymonth', authenticateUser, getQuotesByMonth)
