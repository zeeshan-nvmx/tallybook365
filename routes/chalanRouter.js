...
const { createChalan, getAllChalans, getChalan, deleteChalan, updateChalan, getChalanSerialNumber, getChalansByMonth } = require("../controllers/chalanController")
...
chalanRouter.get('/chalans/getchalansbymonth', authenticateUser, getChalansByMonth)
